package com.gaoyifeng.IDaaS.domain.weixin.service.behavior;
...
import com.gaoyifeng.IDaaS.domain.weixin.model.valobj.MsgTypeVO;
...
//            }
            ...
            res.setMsgType("text");
            res.setContent(String.format("您的验证码为：%s 有效期%d分钟！", "123456", 3));
